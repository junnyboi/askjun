            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  image: "/manus-storage/proj-teapets3d-v2_40b8013d.png",
                ...
                },
                {
                  ...
                  image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663370222890/cA3toqknd22cLAL6g9pNa6/proj-teapets2d-WsyiN7NPZsQDmL9vBVLT3U.webp",
                ...
                <div key={i} className="group border border-border rounded-lg overflow-hidden hover:border-accent/50 hover:-translate-y-1 hover:shadow-lg hover:shadow-accent/5 transition-all duration-300 ease-out">
                  ...
                  <div className="p-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <a href={(project as any).github} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} className="text-muted-foreground hover:text-foreground hover:scale-125 hover:rotate-12 transition-all duration-200 ease-out">
