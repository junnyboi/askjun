...
const TOOL_MAP: Array<{ keywords: string[]; match: StructuredMatch }> = [
  ...
  {
    keywords: ["handsome", "good looking", "good-looking", "attractive", "cute", "hot", "gorgeous", "pretty", "beautiful", "appearance", "look like", "looks like", "what does he look", "how does jun look", "how does he look", "jun look", "does he look like"],
    match: {
      category: "easter_egg",
